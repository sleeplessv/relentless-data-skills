...
| [`implement-feature`](skills/implement-feature/) | Implement a whole feature as one PR: orchestrate subagents over a PRD's issues on a shared integration branch — waves of issue branches, integrated review + tests, and a single feature PR to main. |
