...
| [`implement-feature`](skills/implement-feature/) | Implement a whole feature as one PR: orchestrate subagents over a spec's tickets on a shared integration branch. Ticket branches land in waves, with integrated review + tests, then a single feature PR to main. |
